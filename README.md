...
* [agent-js](https://github.com/dfinity/agent-js) ⭐ 171 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-17 - Collection of libraries to interact with the IC using JavaScript.
...
* [Azle](https://github.com/demergent-labs/azle) ⭐ 229 | 🐛 395 | 🌐 TypeScript | 📅 2026-09-17 - TypeScript CDK.
...
* [pocket-ic](https://github.com/dfinity/ic/tree/master/packages/pocket-ic) ⭐ 1,792 | 🐛 288 | 🌐 Rust | 📅 2026-09-17 - A canister testing library that supports deterministic, programmatic canister testing in Rust.
...
* [Canic](https://github.com/dragginzgame/canic) ⭐ 10 | 🐛 11 | 🌐 Rust | 📅 2026-09-17 - A Rust toolkit for orchestrating Internet Computer (IC) canisters at scale.

## Motoko

Motoko is a safe, simple, actor-based programming language for authoring Internet Computer (IC) canister smart contracts.

* [Motoko GitHub Repository](https://github.com/dfinity/motoko) ⭐ 590 | 🐛 270 | 🌐 OCaml | 📅 2026-09-17 - The home of the Motoko language.
...
* [Candid GitHub Repo](https://github.com/dfinity/candid) ⭐ 301 | 🐛 66 | 🌐 Rust | 📅 2026-09-17 - The home of Candid.
* [Candid UI](https://github.com/dfinity/candid/blob/master/tools/ui) ⭐ 301 | 🐛 66 | 🌐 Rust | 📅 2026-09-17 - Generates a front-end UI for any canister.
* [didc](https://github.com/dfinity/candid/tree/master/tools/didc) ⭐ 301 | 🐛 66 | 🌐 Rust | 📅 2026-09-17 - A multi-purpose tool for Candid.
...
* [@dfinity/candid](https://github.com/dfinity/agent-js/tree/main/packages/candid) ⭐ 171 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-17 - JavaScript and TypeScript library for Candid.
...
* [IcyDB](https://github.com/dragginzgame/icydb) ⭐ 18 | 🐛 6 | 🌐 Rust | 📅 2026-09-17 - Scalable DB/ORM written in Rust, battle tested and constantly updated.
...
* [ICRC-1/2/3 Rust](https://github.com/dfinity/ic/tree/master/rs/ledger_suite/icrc1) ⭐ 1,792 | 🐛 288 | 🌐 Rust | 📅 2026-09-17 - Fungible token reference implementation by DFINITY.
...
* [OpenChat](https://github.com/open-ic/open-chat) ⭐ 207 | 🐛 303 | 🌐 Rust | 📅 2026-09-17 - An open chat app.
...
* [Internet Identity](https://github.com/dfinity/internet-identity) ⭐ 536 | 🐛 58 | 🌐 Rust | 📅 2026-09-17 - Pseudoymous authentication system for the Internet Computer.
...
* [ckBTC](https://github.com/dfinity/ic/tree/master/rs/bitcoin/ckbtc) ⭐ 1,792 | 🐛 288 | 🌐 Rust | 📅 2026-09-17 - Canister-controlled BTC twin on ICP with 1:1 backing.
...
* [ckETH](https://github.com/dfinity/ic/tree/master/rs/ethereum/cketh) ⭐ 1,792 | 🐛 288 | 🌐 Rust | 📅 2026-09-17 - Canister-controlled ETH twin on ICP with 1:1 backing.
* [Oisy](https://github.com/dfinity/oisy-wallet) ⭐ 176 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-17 - A novel Ethereum wallet that is hosted on the Internet Computer, is browser-based, fully on-chain, and secured by Chain-key cryptography and Internet Identity.
...
* [llama\_cpp\_canister](https://github.com/onicai/llama_cpp_canister) ⭐ 88 | 🐛 2 | 🌐 C++ | 📅 2026-09-16 - llama.cpp for the Internet Computer. (Note: used as a backend for [ICGPT](https://icgpt.icpp.world/))
...
* [ic-mnist](https://github.com/smallstepman/ic-mnist) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2023-05-25 - MNIST (considered to be `hello world` of machine learning) running on IC using [burn](https://github.com/tracel-ai/burn) ⭐ 15,941 | 🐛 310 | 🌐 Rust | 📅 2026-09-17 crate. [Try it here](https://jsi2g-jyaaa-aaaam-abnia-cai.icp0.io/).
...
* [Jolt Verifier Canister](https://github.com/flyq/jolt_verifier_canister) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2024-04-19 - A Canister which can verify the proof generated by [Jolt](https://github.com/a16z/jolt) ⭐ 1,041 | 🐛 43 | 🌐 Rust | 📅 2026-09-17 zkVM.
