...
* [Azle](https://github.com/demergent-labs/azle) ⭐ 230 | 🐛 376 | 🌐 TypeScript | 📅 2026-08-28 - TypeScript CDK.
...
* [Canic](https://github.com/dragginzgame/canic) ⭐ 10 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - A Rust toolkit for orchestrating Internet Computer (IC) canisters at scale.

## Motoko

Motoko is a safe, simple, actor-based programming language for authoring Internet Computer (IC) canister smart contracts.

* [Motoko GitHub Repository](https://github.com/dfinity/motoko) ⭐ 589 | 🐛 263 | 🌐 OCaml | 📅 2026-08-28 - The home of the Motoko language.
...
* [IcyDB](https://github.com/dragginzgame/icydb) ⭐ 17 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - Scalable DB/ORM written in Rust, battle tested and constantly updated.
...
* [OpenChat](https://github.com/open-ic/open-chat) ⭐ 205 | 🐛 301 | 🌐 Rust | 📅 2026-08-28 - An open chat app.
...
* [Jolt Verifier Canister](https://github.com/flyq/jolt_verifier_canister) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2024-04-19 - A Canister which can verify the proof generated by [Jolt](https://github.com/a16z/jolt) ⭐ 1,020 | 🐛 44 | 🌐 Rust | 📅 2026-08-28 zkVM.
